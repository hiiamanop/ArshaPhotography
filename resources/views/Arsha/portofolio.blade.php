                        ...
                        <div class="portfolio-details-slider swiper">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{asset('Arsha/assets/img/portfolio/portfolio-1.jpg')}}" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{asset('Arsha/assets/img/portfolio/portfolio-2.jpg')}}" alt="">
                                </div>

                                <div class="swiper-slide">
                                    <img src="{{asset('Arsha/assets/img/portfolio/portfolio-3.jpg')}}" alt="">
                                </div>
